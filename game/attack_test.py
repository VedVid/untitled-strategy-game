...
#    assert all(
#        x in [(-1, 0), (1, 0), (0, -1), (0, 1)]
#        for x in attack_1.effects[0].target_positions
#    )
#    assert all(
#        x in [(-1, 0), (1, 0), (0, -1), (0, 1)]
#        for x in attack_2.effects[0].target_positions
#    )
#    assert all(
#        x in [(-1, 0), (1, 0), (0, -1), (0, 1)]
#        for x in attack_2.effects[1].target_positions
#    )
